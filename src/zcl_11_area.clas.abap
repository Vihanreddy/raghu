...
public section.
  ...
  constants AREA_NAME type SHM_AREA_NAME value 'ZCL_11_AREA' ##NO_TEXT.
  data ROOT type ref to ZCL_BC402_11_ROOT read-only .
  ...
  class-methods ATTACH_FOR_READ
    ...
    returning
      value(HANDLE) type ref to ZCL_11_AREA
    raising
      CX_SHM_INCONSISTENT
  ...
  methods SET_ROOT
    importing
      !ROOT type ref to ZCL_BC402_11_ROOT
    raising
...
CLASS ZCL_11_AREA IMPLEMENTATION.
